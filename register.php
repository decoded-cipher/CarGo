                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="section-title  text-center">
                            ...
                            <p>Fill-up your entries to step-in and be a part of CarGo family.</p>
                        </div>
                    </div>
                    <!-- Page Title End -->
                </div>
                                ...
                                <form method="POST" action="" name="signup">
                                    ...
                                    <div class="log-btn">
                                        <button type="submit" name="SUBMIT" value="SUBMIT" onClick="return validation();">
                                            <i class="fa fa-check-square"></i> Sign Up</button>
                                    </div>
                                </form>
                            </div>
        ...
        <div id="invalidOTP" class="smodal">
                ...
                <div class="smodal-content">
                    ...
                    <div style="display: inline-block;text-align: center">
                        <img style="margin-left: 40px" src="fail.png" width="150px" height="150px">
                    </div><br>
...
<!--__________________________________________________________________________________________________________________________________-->
        ...
        <script type ="text/javascript" language="javascript">
            function validation()
            {
                ...
                var last_name = document.forms["signup"]["last_name"];
                ...
                var confirm = document.forms["signup"]["confirm"];
