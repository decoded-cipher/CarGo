...
<html class="no-js" lang="zxx">
    ...
    <body class="loader-active">
        ...
        <header id="header-area" class="fixed-top">
            ...
            <?php
            $qry = "SELECT * FROM ride WHERE ride_id =" . $_REQUEST['id'];
            $result = mysqli_query($con, $qry);
            $res0 = mysqli_fetch_array($result);

            $qry = "SELECT * FROM trip INNER JOIN vehicle ON trip.vehicle_id = vehicle.vehicle_id INNER JOIN registration ON  trip.user_id = registration.user_id WHERE trip.datee = '" . $res0['datee'] . "' AND trip.source = '" . $res0['source'] . "' AND trip.destination = '" . $res0['destination'] . "' ORDER BY trip.timee asc";
    // echo $qry;
            $result = mysqli_query($con, $qry);
                                                ...
                                                if ($count > 0) {
                                                    ...
                                                    <ul class="table-post">
                                                        ...
                                                        while ($res = mysqli_fetch_array($result)) {
                                                            $i++;
//                                                       $qry1 = "SELECT * FROM passenger WHERE trip_id=" . $res['trip_id'];
//                                                            
//                                                          echo $qry1;  
                                                                ...
                                                                <form id="frmRequest" name="frmRequest" method="post">
                                                                    ...
                                                                    <div class="xsmodal-content">
                                                                        ...
                                                                        <h4 style="margin: 20px 0px 5px 0px;
                                                                            ...
                                                                            <?php echo $res['first_name'] . ' ' . $res['last_name']; ?></h4>
                                                                        <h6 style="color: gray;"><?php echo $res['mobile']; ?><h6>
                                                                                ...
                                                                                <div class="route">
                                                                                    ...
                                                                                    <div class="abc">
                                                                                        <input type="hidden" name="hdn_trip_id" id="hdn_trip_id" value="<?php echo $res['trip_id']; ?>" >
                                                                                        <input type="hidden" name="hdn_ride_id" id="hdn_ride_id" value="<?php echo $_REQUEST['id']; ?>" >
                                                                                        <?php
                                                                                        if($count1 == 0)
                                                                                        {
                                                                                            ?>
                                                                                          <button type="submit" id="btn_request" name="btn_request">Send Request</button>
                                                                                        <?php
                                                                                        }
                                                                                        else{
                                                                                        if ($res1['status'] == 0) {
                                                                        ...
                                                                        if (isset($_REQUEST['btn_request'])) {
                                                                            $trip_id = $_REQUEST['hdn_trip_id'];
                                                                            $ride_id = $_REQUEST['hdn_ride_id'];
                                                                            $qry = "INSERT INTO passenger (trip_id, ride_id, status) VALUES ($trip_id, $ride_id, 0)";
